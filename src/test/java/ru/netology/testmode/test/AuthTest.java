...
class AuthTest {
    ...
    void shouldGetErrorIfNotRegisteredUser() {
        ...
        $(byText("Продолжить")).click();
        $("[data-test-id=error-notification] .notification__content").shouldHave(Condition.text("Ошибка!")).shouldBe(Condition.visible);
    ...
    void shouldGetErrorIfWrongLogin() {
        ...
        $("[data-test-id=login] input").sendKeys(registeredUser.getLogin());
        $("[data-test-id=password] input").sendKeys(wrongLogin);
        $(byText("Продолжить")).click();
        $("[data-test-id=error-notification] .notification__content").shouldHave(Condition.text("Ошибка!")).shouldBe(Condition.visible);
